...
function init() {
  ...
  // custom cubemap
    ...
    let sphere = new THREE.Mesh(sphereGeometry, cartonMaterial);
    sphere.position.y = 5;
...
function vertices() {
    ...
    let material = new THREE.MeshLambertMaterial({map: loader.load('media/milkfeettextflash-sq-purple.jpg'), side: THREE.DoubleSide});
